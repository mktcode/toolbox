...
export default async function Navbar() {
  ...
  return (
    <div className="flex items-center px-4 py-2 border-b fixed w-full">
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" className="w-8 mr-2">
